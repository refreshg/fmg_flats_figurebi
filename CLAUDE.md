...
- ⚠️ **კომპანიის default sale tax კვლავ 15%-ია** — ახალი/იმპორტირებული პროდუქტი ისევ
  გადასახადით შეიქმნება! ბინების იმპორტისას taxes_id ცარიელი უნდა ჩაიწეროს (PLAN M1-შია),
  ან მომხმარებელმა Settings-ში default sales tax მოხსნას (ბიზნეს-გადაწყვეტილებაა)
